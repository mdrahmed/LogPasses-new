...
@.str.1 = private unnamed_addr constant [21 x i8] c"a is greater than 10\00", align 1
@.str.2 = private unnamed_addr constant [18 x i8] c"a is less than 10\00", align 1
...
define dso_local noundef i32 @main(i32 noundef %0, i8** noundef %1) #1 {
  ...
  %8 = call i32 (i8*, ...) @scanf(i8* noundef getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i32* noundef %6, i32* noundef %7)
  %9 = load i32, i32* %6, align 4
  %10 = icmp sgt i32 %9, 10
  br i1 %10, label %11, label %16

11:                                               ; preds = %2
  %12 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([21 x i8], [21 x i8]* @.str.1, i64 0, i64 0))
  %13 = load i32, i32* %6, align 4
  %14 = load i32, i32* %7, align 4
  %15 = call noundef i32 @_Z8subtractii(i32 noundef %13, i32 noundef %14)
  br label %21

16:                                               ; preds = %2
  %17 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([18 x i8], [18 x i8]* @.str.2, i64 0, i64 0))
