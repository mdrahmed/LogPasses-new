...
define linkonce_odr dso_local void @_ZN4mqtt12make_messageENS_10buffer_refIcEES1_(%"class.std::shared_ptr.111"* noalias sret(%"class.std::shared_ptr.111") align 8 %0, %"class.mqtt::buffer_ref"* noundef %1, %"class.mqtt::buffer_ref"* noundef %2) #7 comdat personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  %10 = call noundef i8* @_ZNK4mqtt10buffer_refIcE5c_strEv(%"class.mqtt::buffer_ref"* noundef nonnull align 8 dereferenceable(16) %1)
  %11 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([38 x i8], [38 x i8]* @.str.21, i64 0, i64 0), i8* noundef %10)
  %12 = call noundef nonnull align 8 dereferenceable(16) %"class.mqtt::buffer_ref"* @_ZSt4moveIRN4mqtt10buffer_refIcEEEONSt16remove_referenceIT_E4typeEOS5_(%"class.mqtt::buffer_ref"* noundef nonnull align 8 dereferenceable(16) %1) #3
  call void @_ZN4mqtt10buffer_refIcEC2EOS1_(%"class.mqtt::buffer_ref"* noundef nonnull align 8 dereferenceable(16) %5, %"class.mqtt::buffer_ref"* noundef nonnull align 8 dereferenceable(16) %12) #3
  %13 = call noundef nonnull align 8 dereferenceable(16) %"class.mqtt::buffer_ref"* @_ZSt4moveIRN4mqtt10buffer_refIcEEEONSt16remove_referenceIT_E4typeEOS5_(%"class.mqtt::buffer_ref"* noundef nonnull align 8 dereferenceable(16) %2) #3
  call void @_ZN4mqtt10buffer_refIcEC2EOS1_(%"class.mqtt::buffer_ref"* noundef nonnull align 8 dereferenceable(16) %6, %"class.mqtt::buffer_ref"* noundef nonnull align 8 dereferenceable(16) %13) #3
